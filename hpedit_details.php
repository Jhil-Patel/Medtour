...
<tr>
    <td>Facilities :</td>
    <td><input type="checkbox" name="fac[]" value="Private Rooms"
    <?php
    ...
    ?>    
    >Private Rooms</td>
    <td><input type="checkbox" name="fac[]" value="Cafeteria/Restaurant"
    <?php
    ...
    <td><input type="checkbox" name="fac[]" value="Pharmacy"
    <?php
    ...
    ?>  
    >Pharmacy</td>
    <td><input type="checkbox" name="fac[]" value="Ambulance Facility"
    <?php
    ...
    <td><input type="checkbox" name="fac[]" value="Internet Connection"
    <?php
...
<tr>
    <td></td>
    <td><input type="checkbox" name="fac[]" value="Money Exchange"
    <?php
    ...
    ?>  
    >Money Exchange</td>
    <td><input type="checkbox" name="fac[]" value="Transportation service"
    <?php
    ...
    <td><input type="checkbox" name="fac[]" value="Flight arrangement"
    <?php
    ...
    <td><input type="checkbox" name="fac[]" value="Visa arrangement"
    <?php
